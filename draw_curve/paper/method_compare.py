...
rename_m = {
    'e2lsh': 'LSH Counting Index',
    'knn': 'KNN',
    'kmeans_multiple': "Joint KMeans",
    'knn_random_projection':"KNN Random Projection"
}
...
method_l = [
    'e2lsh', 'knn', 'kmeans_multiple', 'knn_random_projection'
]
n_classifier_l = [
    4
]
